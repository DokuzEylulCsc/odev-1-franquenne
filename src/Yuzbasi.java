...
public class Yuzbasi extends Asker {
    public Yuzbasi(int team, Koordinat koordinat, PrintWriter yaz) {
    ...
    protected String getAskerAdı() {
        ...
        return (getTeam()==0?"Kırmızı":"Mavi")+" Yüzbaşı "+" ("+this+") ";
    }
    ...
    public void Hareket_et(Asker[][] meydan) {
        ...
        if (yon == 1) {
            ...
            if (koordinat.getX() != 0 && koordinat.getY() != 15 && meydan[koordinat.getX() - 1][koordinat.getY() + 1] == null) {
                koordinat.moveUpperLeft();
            } else {
                Bekle();
            }
        } else if (yon == 5) {
            if (koordinat.getX() != 15 && koordinat.getY() != 15 && meydan[koordinat.getX() + 1][koordinat.getY() + 1] == null) {
                koordinat.moveUpperRight();
            } else {
                Bekle();
            }
        } else if (yon == 6) {
            if (koordinat.getX() != 15 && koordinat.getY() != 0 && meydan[koordinat.getX() + 1][koordinat.getY() - 1] == null) {
                koordinat.moveLowerRight();
            } else {
                Bekle();
            }
        } else if (yon == 7) {
            if (koordinat.getX() != 0 && koordinat.getY() != 0 && meydan[koordinat.getX() - 1][koordinat.getY() - 1] == null) {
                koordinat.moveLowerLeft();
            } else {
                Bekle();
            }
        }
